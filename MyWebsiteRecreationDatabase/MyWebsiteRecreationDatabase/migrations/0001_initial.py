# Generated by Django 3.2.18 on 2023-05-23 23:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('resource_bridge_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='MyWebsiteRecreationDatabase.resource_bridge')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('resource_list_id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('video_bridge_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='MyWebsiteRecreationDatabase.video_bridge')),
            ],
        ),
        migrations.CreateModel(
            name='Resume',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('page_bridge_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='MyWebsiteRecreationDatabase.page_bridge')),
            ],
        ),
        migrations.CreateModel(
            name='Image_List',
            fields=[
                ('resource_list_id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('image_bridge_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='MyWebsiteRecreationDatabase.image_bridge')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_list_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='MyWebsiteRecreationDatabase.page_list')),
                ('resource_list_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='MyWebsiteRecreationDatabase.resource_list')),
                ('video_lits_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='MyWebsiteRecreationDatabase.video_list')),
            ],
        ),
    ]
